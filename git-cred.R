...
usethis::use_git_config(user.name = "MRaikar", user.email = "manas.raikar@students.iiserpune.ac.in")
...
credentials::set_github_pat() #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
